...
# Student ID:   22307822
#
# task3.py - Modify to create the Bee World
#
...
## (b) create the function plot_world to plot the world array. 
def plot_world(ax):
...
for t in range(simlength):
    ...
    fig.suptitle(f"BEE WORLD. {simlength}", fontsize=15, fontweight='bold')
